...
class WorldManager(private val plugin: OneShotOneKill) {
    ...
    companion object {
        ...
        /** Praefix aller OSOK-Welten - daran erkennt auch der WorldRuleListener sie wieder. */
        const val WORLD_PREFIX = "OSOK_"

        private fun worldNameOf(config: MapConfig) = "$WORLD_PREFIX${config.name}"
