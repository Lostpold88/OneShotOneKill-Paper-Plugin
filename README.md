...
- **🎯 1-Hit Kill Kampfsystem**:
  ...
  - **↔ Respawn mit Abstand zum Todespunkt**: Der Spawn hält mindestens **16 Blöcke** Abstand zu der Stelle, an der man eliminiert wurde – sonst landet man regelmäßig direkt neben seinem Killer und ist beim nächsten Treffer sofort wieder draußen. Bewusst als „möglichst weit weg" und nicht als harte Zusage umgesetzt: Findet die Suche keinen ausreichend entfernten Platz, kommt der erstbeste gültige zurück – gar kein Spawnpunkt wäre schlimmer als ein etwas zu naher. Gilt für die reguläre Eliminierung *und* für echte Tode über den `PlayerRespawnEvent`.
