...
- **☢ Nuke-Finale – so endet eine Runde**:
  ...
  - Die *Wirkung* hängt bewusst **nicht** an den Wolken (deren Trefferprüfung ist flach und endet an Wänden), sondern an einer eigenen Dosis-Buchführung: Jede Sekunde steigt die Dosis, Sicht und Tempo brechen ein, die Lebensanzeige sinkt sichtbar mit – und nach **25 Sekunden** erstickt der Spieler. Ab acht Restsekunden wird es zusätzlich schwarz vor Augen. Dazu ein **Herzschlag, der mit der Dosis schneller und höher wird**, und das Knistern eines Geigerzählers, das sich zum Ende hin verdichtet.
  ...
  - Insgesamt dauert das Finale rund **40 Sekunden**: 8 Sekunden Anflug, 4 Sekunden Druckwelle, 25 Sekunden Gas – die Pilzwolke steht die ganze Zeit über der Arena.
